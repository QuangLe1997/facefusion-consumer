...
def finalize_image(output_path: str, output_image_resolution: str, **kwargs) -> bool:
	output_image_quality = kwargs.get('output_image_quality', facefusion.globals.output_image_quality)

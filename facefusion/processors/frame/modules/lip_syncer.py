...
def sync_lip(target_face: Face, temp_audio_frame: AudioFrame, temp_vision_frame: VisionFrame, **kwargs) -> VisionFrame:
	...
	box_mask = create_static_box_mask(
		...
		kwargs.get('face_mask_blur', facefusion.globals.face_mask_blur),
		kwargs.get('face_mask_padding', facefusion.globals.face_mask_padding)
	)
...
def process_frame(inputs: LipSyncerInputs, **kwargs) -> VisionFrame:
	...
	if face_selector_mode == 'many':
		...
		if many_faces:
			for target_face in many_faces:
				target_vision_frame = sync_lip(target_face, source_audio_frame, target_vision_frame, **kwargs)
	...
	if face_selector_mode == 'reference':
		...
		if similar_faces:
			for similar_face in similar_faces:
				target_vision_frame = sync_lip(similar_face, source_audio_frame, target_vision_frame, **kwargs)
